...
#[cfg(feature = "nightly")]
fuzz_target!(|data: inner::TokensWrapped| {
    use kuiper_lang::lex::{compile_from_tokens, CompilerConfig};
...
mod inner {
    ...
    use kuiper_lang::lex::{Operator, Token, TypeLiteral, UnaryOperator};
